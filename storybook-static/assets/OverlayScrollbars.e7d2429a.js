import { Z as Nc, e as xe } from './iframe.37e1393d.js';
var Gs = { exports: {} };
/*!
 * OverlayScrollbars
 ...
 */ (function (ae) {
  (function (X, or) {
    ae.exports = or(X, X.document, void 0);
  })(typeof window != 'undefined' ? window : Nc, function (X, or, w) {
    var ke = 'OverlayScrollbars',
      ...
      He = (function () {
        ...
        return {
          ...
          _cssProperty: function (d) {
            ...
            for (
              var vr = u(d), ir = or.createElement('div')[s.s], E, V = 0, mr, U;
              V < e.length;
              V++
            )
              for (
                U = e[V].replace(/-/g, ''),
                  E = [d, e[V] + d, U + vr, u(U) + vr],
                  mr = 0;
                mr < E[s.l];
                mr++
              )
          ...
          _cssPropertyValue: function (d, T, vr) {
            ...
            for (
              var V = or.createElement('div')[s.s],
                mr = T.split(' '),
                U = vr || '',
                Pr = 0,
                H = -1,
          ...
          _jsAPI: function (d, T, vr) {
            var ir = 0,
              E = g[d];
            if (!g[s.hOP](d)) {
              for (E = X[d]; ir < f[s.l]; ir++)
                E = E || X[(T ? f[ir] : f[ir].toLowerCase()) + u(d)];
              g[d] = E;
            }
            return E || vr;
          }
      ...
      O = (function () {
        function g(e) {
          return e
            ? X.innerWidth || or.documentElement[s.cW] || or.body[s.cW]
            : X.innerHeight || or.documentElement[s.cH] || or.body[s.cH];
        }
        function m(e, f) {
          ...
          page: function (e) {
            ...
            return !e[f + d] && e[u + d] && e[u + d] != null
              ? {
                  x:
                    e[u + d] +
                    ((E && E.scrollLeft) || (V && V.scrollLeft) || 0) -
                    ((E && E.clientLeft) || (V && V.clientLeft) || 0),
                  y:
                    e[u + T] +
                    ((E && E.scrollTop) || (V && V.scrollTop) || 0) -
                    ((E && E.clientTop) || (V && V.clientTop) || 0)
                }
              : { x: e[f + d], y: e[f + T] };
          },
          mBtn: function (e) {
            ...
            return e == 0
              ...
              : (vr || (vr = d * 0.3),
                ir < g.a(u)
                  ? ((ir = u), (T = vr / 4))
                  : (T = (vr / (2 * g.p)) * g.n(u / ir)),
                ir * g.w(2, -10 * e) * g.s(((e * d - T) * (2 * g.p)) / vr) +
                  u +
                  f);
          },
      ...
      R = (function () {
        ...
        function U(t) {
          ...
          var o,
            ...
            S =
              t.constructor &&
              t.constructor[n] &&
              v.call(t.constructor[n], 'isPrototypeOf');
        ...
        function H(t) {
          ...
          return V(n)
            ? !1
            : n == p.a || o === 0 || (T(o) == p.n && o > 0 && o - 1 in t);
        }
        function Q(t) {
          var o = t.match(g) || [];
          return o.join(m);
        ...
        function $(t, o) {
          for (
            var n = (t.parentNode || or).querySelectorAll(o) || [], v = n[s.l];
            v--;
        ...
        function K(t, o) {
          ...
          o !== !1 && t.q.splice(0, 1),
            t.q[s.l] > 0
              ? ((v = t.q[0]),
                A(t.el, v.props, v.duration, v.easing, v.complete, !0))
                  ...
                  (xa = function () {
                    ...
                    for (Y in rr)
                      (ge = parseFloat(J[Y])),
                        (Ue = parseFloat(rr[Y])),
                        (dr =
                          (Ue - ge) * Js[qr[Y] || v](pe, pe * Or, 0, 1, Or) +
                          ge),
                        Kr(t, Y, dr),
                        V(Ir) &&
                          Ir(dr, {
                    ...
                    V(Er) && Er({}, pe, N.max(0, Or - Ce)),
                      Tr ? (K(Yr), V(b) && b()) : (xr.frame = O.rAF()(xa));
                  }),
                  (xr.frame = O.rAF()(xa));
              else {
          ...
          (G[s.p] = {
              ...
              return this.each(function () {
                ...
                try {
                  if (b.addEventListener)
                    for (; v < n; v++) b.addEventListener(t[v], o);
                  else if (b.detachEvent)
                    for (; v < n; v++) b.attachEvent('on' + t[v], o);
                } catch {}
              });
            },
            off: function (t, o) {
              ...
              return this.each(function () {
                ...
                try {
                  if (b.removeEventListener)
                    for (; v < n; v++) b.removeEventListener(t[v], o);
                  else if (b.detachEvent)
                    for (; v < n; v++) b.detachEvent('on' + t[v], o);
                } catch {}
              });
            },
            one: function (t, o) {
            ...
            unwrap: function () {
              ...
              for (
                ...
                for (n = t[o], v = n.parentNode; n.firstChild; )
                  v.insertBefore(n.firstChild, n);
                v.removeChild(n);
              }
              return this;
            },
            wrapAll: function (t) {
              for (
                var o,
                  ...
                  b = v,
                  S = n[0].parentNode,
                  D = n[0].previousSibling;
                b.childNodes[s.l] > 0;

              )
                b = b.childNodes[0];
              for (o = 0; n[s.l] - o; b.firstChild === n[0] && o++)
                b.appendChild(n[o]);
            ...
            hasClass: function (t) {
              for (var o, n = 0, v = m + t + m, b; (o = this[n++]); ) {
                ...
                if (
                  o.nodeType === 1 &&
                  (m + Q(o.className + e) + m).indexOf(v) > -1
                )
                  return !0;
              }
              return !1;
              ...
              if (t) {
                for (o = t.match(g) || []; (n = this[z++]); )
                  if (((rr = n.classList), J === w && (J = rr !== w), J))
                    ...
                    ((b = n.className + e),
                    (v = n.nodeType === 1 && m + Q(b) + m),
                    v)
                  ) {
                    for (; (S = o[Y++]); )
                      v.indexOf(m + S + m) < 0 && (v += S + m);
            ...
            offset: function () {
              var t = this[0],
                o = t[s.bCR](),
                n = X.pageXOffset || or.documentElement[f],
                v = X.pageYOffset || or.documentElement[u];
              ...
              return (
                this.each(function () {
                  for (v = this.children, b = 0; b < v[s.l]; b++)
                    (n = v[b]),
                      t
                        ? ((n.matches && n.matches(t)) || $(n, t)) && o.push(n)
                        : o.push(n);
                }),
                G(o)
              );
            ...
            parent: function (t) {
              ...
              return (
                this.each(function () {
                  (n = this.parentNode), (!t || G(n).is(t)) && o.push(n);
                }),
                G(o)
              );
            },
            ...
            contents: function () {
              ...
              return (
                this.each(function () {
                  for (o = this.childNodes, n = 0; n < o[s.l]; n++)
                    t.push(o[n]);
                }),
                G(t)
              );
                    ...
                    for (var Tr in Er)
                      if (Er[s.hOP](Tr) && Yr[s.hOP](Tr)) {
                        var pe = !1,
                          ...
                          ga = Fe ? Fe + '.' : '',
                          Pt =
                            'The option "' + ga + Tr + `" wasn't set, because`,
                          te = [],
                          _e = [],
                          qe,
                          Rr,
...
` + X.JSON.stringify(J, null, 2)
        ...
        function T(E) {
          ...
          R.extend(V, {
            ...
            nativeScrollbarStyling: (function () {
              ...
              try {
                A =
                  ...
                  X.getComputedStyle($, '::-webkit-scrollbar').getPropertyValue(
                    'display'
                  ) === 'none';
              } catch {}
              return A;
            ...
            (function () {
                ...
                t = function () {
                  if (Ma().length > 0) {
                    ...
                    var J = N.round(v / (pr / 100)),
                      ...
                      Fe = Ir !== G && G > 0,
                      Tr = qr && Or && Fe,
                      pe = V.nativeScrollbarSize,
                      ge;
                    Tr &&
                      (H.append(Q),
                      (ge = V.nativeScrollbarSize = Kr(Q[0])),
                      Q.remove(),
                      (pe.x !== ge.x || pe.y !== ge.y) &&
                        R.each(Ma(), function () {
              ...
              function n() {
                var v = X.screen.deviceXDPI || 0,
                  b = X.screen.logicalXDPI || 1;
                return X.devicePixelRatio || v / b;
              }
              R(X).on('resize', t);
            })();
          function Kr(A) {
        ...
        function ir(E, V, mr, U, Pr) {
          ...
          var K,
            ...
            ut = Ne + 'dragging',
            fn = Ne + 'theme-none',
            Qn = [qn, Ui, ji, Ki, Yi, Bt, Ft, Gi, Ji, Zi, ut].join(oe),
            Kn = [],
            Yn = [s.ti],
            Xi,
            Ut,
          ...
          function Be(r, a, i, c, l) {
            var h = O.isA(a) && O.isA(i),
              ...
              Z = W && (l._capture || !1),
              er = b ? { passive: P, capture: Z } : Z;
            if (h) for (; C < a[s.l]; C++) Be(r, a[C], i[C], c, l);
            else
              for (; C < y[s.l]; C++) b ? r[0][_](y[C], i, er) : r[x](y[C], i);
          }
          function pa(r, a, i, c) {
            ...
            if (r) {
              ...
              if (a) {
                if (S) {
                    ...
                    Ye(
                      ...
                      Ye(
                        ...
                        Ye(ln, Ye(qi)) +
                          Ye(
                            ln,
                            Ye({ c: qi, style: 'width: 200%; height: 200%' })
                          )
                      )
                    )
                  );
                  ...
                  if (ee)
                    r.prepend(Ye(lt)),
                      Ht(r, je + lt)[0].attachEvent('onresize', _);
                  else {
          ...
          function ks(r, a) {
            ...
            if ((h > -1 && l.splice(h, 1), l[s.l] > 0)) {
              for (x = Ds(!0, !0), _ = 0; _ < l.length; _++)
                if (!l[_].match(x)) return !0;
            }
            return !1;
          }
          function cc(r) {
            ...
            if (c === 'attributes' && (a === s.c || a === s.s) && !z) {
              if (a === s.c && R(i).hasClass(we))
                return ks(r.oldValue, i.className);
          ...
          function lc(r) {
            ...
            var a = 'flex-grow',
              ...
              Z = !1,
              er = function (cr, q) {
                for (var lr = 0; lr < cr[s.l]; lr++)
                  if (cr[lr] === q) return !0;
                return !1;
              };
            return (
              P && ((Z = er(_, r)), !Z && !Ir && (Z = er(x, r))),
              W && !Z && ((Z = er(l, r)), !Z && !Ir && (Z = er(h, r))),
              Z
            );
          }
          function pi(r) {
          ...
          function _a(r) {
            ...
            if (
              ...
              if (
                ...
                ze &&
                  (be(F, ri + oe + fn),
                  Gr(F, Vr !== w && Vr !== null && Vr.length > 0 ? Vr : fn)),
                kr &&
                  (L === !0 || (L === null && pr)
                    ? (fi(), Pr.add(k))
                    : (Pr.remove(k), ws())),
                ...
                if (Fr)
                  if ((Ee ? Ee.show() : ((Ee = R(Ye($s))), $e.before(Ee)), qr))
                    fa.show();
                  else {
              ...
              l && (ha.find('*').trigger(Ve), qr && fa.find('*').trigger(Ve)),
                (x = x === w ? F.is(':hidden') : x);
              ...
              (dr = Ze === 'rtl'), (Ir = Ka === 'border-box');
              var fe = dr ? _r : ce,
                ur = dr ? ce : _r,
                ia = !1,
                nt =
                  qr && F.css(We) !== 'none'
                    ? N.round(ue.right - ue.left) === 0 &&
                      (Zr ? !0 : Qe[s.cW] - Or > 0)
                    : !1;
              if (Fr && !nt) {
                var Ct = Qe[s.oW],
              ...
              if (
                ...
                mt(I, te, [-Mr.t, -Mr.r, -Mr.b, -Mr.l]),
                  Zr
                    ? (mt(Xr, B, it), mt(z ? Ie : M, _e))
                    : (mt(Xr, B), mt(z ? Ie : M, _e, it)),
                  $e.css(Xr),
                  sr.css(Ie);
              }
              xr = Le();
              ...
              if (
                ((ys = Sr),
                wr && (de || Br || Xe || Mr.c || ca.c)
                  ? (M[zr] = $r)
                  : (de || Br) && (M[zr] = Ra),
                nr && (he || Br || Xe || Mr.c || ca.c || Te)
                  ? ((M[j] = $r), (I[Ia + j] = Ra))
                  : (he || Br) && ((M[j] = Ra), (M[We] = B), (I[Ia + j] = B)),
                nr
                  ? ((I[j] = $r),
                    (M[j] =
                      He._cssPropertyValue(j, 'max-content intrinsic') || $r),
                    (M[We] = ur))
                  : (I[j] = B),
                ...
                G ||
                  ((Pa[Se] = sa ? B : yc), (Pa[fe] = Ga ? B : wi), ar.css(Pa)),
                  (xr = Le());
                var en = jr(),
                  Ei = {
                    w: en.w - ge - Tr - (Ir ? 0 : Or),
                    h: en.h - Ue - pe - (Ir ? 0 : Fe)
                  },
                  St = {
                ...
                if (
                  ...
                  var mc = 'px solid transparent',
                    ...
                    ki;
                  (Nr.x || Nr.y) &&
                    ((Za.w = K.y && Nr.y ? ot.w + Kr.y : B),
                    (Za.h = K.x && Nr.x ? ot.h + Kr.x : B),
                    (En = y(Za, as)),
                    (as = Za)),
                    (Nr.c ||
                      Ar.c ||
                      ...
                      (ki = function (Qr) {
                        ...
                        K[Ur] && Nr[Ur] && Ar[Ur + 's']
                          ? ((M[te + fr] = ma ? (Cr ? B : Kr[Ur]) : B),
                            (M[qe + fr] =
                              (Qr ? !ma : !0) && !Cr ? Kr[Ur] + mc : B))
                          : ((Za[ua._w_h] = M[te + fr] = M[qe + fr] = B),
                            (En = !0));
                      }),
                ...
                if (
                  ...
                  (Nr.x && Ar.x) || (Nr.y && Ar.y) || Ti
                    ...
                    : (!ee || an.x || Nt.x || an.y || Nt.y) &&
                      (z && (Xr[Ja] = Xr[Na] = B), (se[Ja] = se[Na] = la)),
                  $e.css(Xr),
                  ar.css(se),
                  (se = {}),
                  (Nr.c || Xe || he || de) && !(K.x && K.y))
                ) {
                  var Tn = da[s.s];
                ...
                if (((M = {}), Te || he || de))
                  if (dr && nr) {
                    var xc = Wr.css(We),
                      Vs = N.round(Wr.css(We, B).css(_r, B).position().left);
                    Wr.css(We, xc);
                ...
                if ((Wr.css(M), z && c)) {
                  var za = pc();
                  if (za) {
                    var js = ei === w ? !0 : za._rows !== ei._rows,
                      Qs = za._cursorRow,
                      Cc = za._cursorColumn,
                      Ac = za._widestRow,
                      Oc = za._rows,
                ...
                ta(F, Wt, Ar.x || Ar.y),
                  ...
                  (i || Da.c || de || he || Jr || Xe || Br || gr || Te) &&
                    (xi(!0), ba(!0), xi(!1), ba(!1)),
                  tr && Ps(!0, lr),
                  ye && Ps(!1, Lr),
                  Ke('onDirectionChanged', { isRTL: dr, dir: Ze }, Te),
              ...
              Y &&
                ...
                (Aa.c || et.c) &&
                (et.f || Ls(),
                K.y && Aa.x && Wr.css(Oe + j, et.w + Kr.y),
          ...
          function yi(r) {
            var a = 'parent',
              ...
              x = function () {
                var W = r ? sr : F;
                $(_, function (P, Z) {
                  H(Z) == p.s && (P == s.c ? W.addClass(Z) : W.attr(P, Z));
                });
              },
              y = [
                we,
              ...
              r
                ? (Er && J
                    ...
                    : (ja(ha),
                      ...
                      z && (sr.unwrap(), ja(F), ja(Ua), x())),
                  z && sr.removeAttr(s.s),
                  Y && be(Et, zi))
                : (z &&
                    (re.sizeAutoCapable ||
                      ((C[j] = sr.css(j)), (C[zr] = sr.css(zr))),
          ...
          function uc() {
            ...
            function P(q) {
              var lr = q.keyCode;
              Q(lr, r) < 0 &&
                (a[s.l] || (_(), (i = setInterval(_, 1e3 / 60))),
                Q(lr, a) < 0 && a.push(lr));
            }
            function Z(q) {
              var lr = q.keyCode,
            ...
            z
              ? (br > 9 || !pr ? pa(sr, 'input', _) : pa(sr, [Mn, In], [P, Z]),
                pa(sr, [Ve, 'drop', h, h + 'out'], [x, y, C, W]))
              : pa(Wr, Rn, er),
              pa(ar, Ve, cr, !0);
          }
          function mi(r) {
            var a = function (h) {
              var _ = h ? ec : ac,
                ...
                C = Va(Qi, x);
              return (
                !Er && !r && (x.append(y), y.append(C)),
                { _scrollbar: x, _track: y, _handle: C }
              );
            };
            function i(h) {
              var _ = aa(h),
          ...
          function Ss(r) {
            ...
            function Jr(L) {
              var kr = L.originalEvent || L,
                Hr = kr.touches !== w;
              return Dr || rr || Zt() || !$n || (Hr && !tr('touchSupport'))
                ? !1
                : O.mBtn(L) === 1 || Hr;
            }
            function Zr(L) {
            ...
            function Br(L) {
              if (
                ((L = L || L.originalEvent),
                Be(Ca, [It, Mt, Mn, In, Rt], [Zr, Br, ze, ne, Jt], !0),
                O.rAF()(function () {
                  Be(Ca, C, Vr, !0, { _capture: !0 });
                }),
                tt && ba(r, !0),
                (tt = !1),
                be(ht, ut),
                ...
                (q = 1),
                ye(),
                Z !== w && (k.scrollStop(), clearTimeout(Z), (Z = w)),
                L)
              ) {
                var kr = Qe[s.bCR](),
                  Hr =
            ...
            function ya(L) {
              (er = ar[_]()),
                ...
                Gr(a._handle, x),
                Gr(a._scrollbar, x),
                Be(Ca, [It, Mt, Rt], [Zr, Br, Jt]),
                O.rAF()(function () {
                  Be(Ca, C, Vr, !1, { _capture: !0 });
                }),
                (br || !Yr) && O.prvD(L),
                O.stpP(L);
            }
            function Fr(L) {
              if (Jr(L)) {
                var kr =
                    ...
                    Math.round(
                      N.min(1, xr[a._w_h] / bt[a._w_h]) * a._info._trackLength
                    ),
                          ...
                          ? (ar[_](nr),
                            La
                              ? ((nr = ar[_]()),
                                ...
                                k.scroll(
                                  wr,
                                  De(de, { duration: 130, complete: Xe })
                                ))
                              : Xe())
                          : ((Ze = Je ? Ga : Ze),
                            (Te = he
          ...
          function ba(r, a) {
            var i = H(a) == p.b,
              ...
              tr,
              Lr =
                (_t[Ve + h._Width_Height] - _t['client' + h._Width_Height]) *
                (A.n && l ? -1 : 1),
              ye = function (Br) {
            ...
            for (
              var c = '\\s*(([^,(]+(\\(.+?\\))?)+)[\\s,]*',
                ...
                Z = function (er) {
                  ...
                  for (; er.match(l); )
                    y.push(RegExp.$1), (er = er.replace(l, B));
                  return y;
                };
              W < _[s.l];
              W++
            )
              for (C = Z(r.css(a + '-' + _[W])), P = 0; P < C[s.l]; P++)
          ...
          function Ds(r, a) {
            var i,
              ...
              h = function (_, x) {
                if (((l = ''), x && typeof _ == p.s))
                  for (c = _.split(oe), i = 0; i < c[s.l]; i++)
                    l += '|' + c[i] + '$';
                return l;
              };
            return new RegExp(
...
`),
          ...
          function Va(r, a) {
            ...
            return Er && !c[s.l]
              ? null
              : Er
              ? c[i ? 'children' : 'find'](je + r.replace(/\s/g, je)).eq(0)
              : R(Ye(r));
          }
          function Oi(r, a) {
            for (var i = a.split(je), c = 0, l; c < i.length; c++) {
          ...
          function _c(r, a, i) {
            for (
              var c = a.split(je), l = c.length, h = 0, _ = {}, x = _;
              h < l;
              h++
            )
              _ = _[c[h]] = h + 1 < l ? {} : i;
          ...
          (k.sleep = function () {
                  ...
                  c
                    ? r === $r
                      ...
                      ? Oa
                        ...
                        : (h = k.update($r))
                      : r === 'zoom' &&
                        _a({ _hostSizeChanged: !0, _contentSizeChanged: !0 })
                    : ((r = Dr || r),
                      (Dr = !1),
                      (!k.update(Nn) || r) && _a({ _force: r })),
                  Hs(),
                  l || h || _
                );
              }
            ...
            (k.scroll = function (r, a, i, c) {
              ...
              function Xe(M, I) {
                ...
                if (((I = H(I) == p.s || H(I) == p.n ? [I, I] : I), O.isA(I)))
                  return M ? I[0] : I[1];
                if (H(I) == p.o) {
                  for (tr = 0; tr < jr[Cr]; tr++)
                    if (jr[tr] in I) return I[jr[tr]];
                }
              }
              function Mr(M, I) {
                var jr = H(I) == p.s,
                ...
                if (
                  (jr
                    ? (I[Cr] > 2 &&
                        ((Na = I.substr(0, 2)), Q(Na, cr) > -1 && (Le = Na)),
                      (I = Le ? I.substr(2) : I),
                      (I = I[ie](/min/g, 0)
                        [ie](/</g, 0)
                        [ie](/max/g, (Sa ? '-' : B) + Ra)
              ...
              function ue(M, I, jr, Le) {
                ...
                if (oa == I) M = [M, M];
                  ...
                  if (((Xr = M[Cr]), Xr > 2 || Xr < 1)) M = yr;
                  else
                    for (Xr === 1 && (M[1] = jr), tr = 0; tr < Xr; tr++)
                      if (((Ie = M[tr]), H(Ie) != I || !Ka(Ie, Le))) {
                        M = yr;
                        break;
                      }
                } else oa == p.o ? (M = [M[Dt] || jr, M[zt] || jr]) : (M = yr);
                return { x: M[0], y: M[1] };
              }
              function fe(M) {
                var I = [],
                ...
                for (tr = 0; tr < M[Cr] && tr !== yr[Cr]; tr++)
                  (jr = M[tr]),
                    (Le = H(jr)),
                    Le == p.b
                      ? I.push(jr ? Ea(Ge.css(te + yr[tr])) : 0)
                      : I.push(Le == p.n ? jr : 0);
                return I;
              }
              if (Je || Xt) {
                  ...
                  if (
                    (dr &&
                      ...
                      A.i &&
                        P &&
                        (sa.x = N.round(
                          Ga[_r] - wr[_r] + (Ce._maxScroll - he.l)
                        ))),
                    kr.x != Zr || kr.y != Zr || L.x == na || L.y == na || dr)
                  ) {
                    var $t = Ge[0],
                      On = v
                        ? $t[s.bCR]()
                        : { width: $t[s.oW], height: $t[s.oH] },
                      ca = {
                        w: On[j] + Hr[3] + Hr[1],
                        h: On[zr] + Hr[0] + Hr[2]
                      },
                      Ha = function (M) {
                        ...
                        it
                          ...
                          : de[yr] ||
                            ((Ie || Sr) &&
                              ((de[yr] = Sr ? Pa : !1),
                              (oa = ie < va ? st > la : st < la)),
                            (sa[yr] -=
                              oa || Xr
                                ? (va / Na - ie / Na) * (M && dr && P ? -1 : 1)
                                : 0));
                      };
                    Ha(!0), Ha(!1);
                  }
                  ...
                  ? q
                    ...
                    : ((ne = { duration: a, complete: Te }),
                      O.isA(i) || R.isPlainObject(i)
                        ...
                        : (ne.easing = i),
                      ar.animate(Lr, ne))
                  : (Vr && ar[ve](Lr[ve]), ze && ar[le](Lr[le]), Ze());
            }),
            ...
            (k.getState = function (r) {
              function a(c) {
                ...
                return h('w', j), h('h', zr), delete l.c, l;
              }
              var i = {
                destroyed: !!a(rr),
                sleeping: !!a(Dr),
            ...
            (k.ext = function (r) {
              ...
              if (H(r) == p.s) {
                if (Ba[s.hOP](r))
                  for (a = De({}, Ba[r]); c < i.length; c++) delete a[i[c]];
              } else {
                a = {};
            ...
            (k.addExt = function (r, a) {
              ...
              if (i) {
                ...
                if (
                  ...
                  c &&
                    ((h = c.contract),
                    H(h) == p.f && ((_ = h(X)), (x = H(_) == p.b ? _ : x)),
                    x))
                )
                  return (
                    (Ba[r] = c), (l = c.added), H(l) == p.f && l(a), k.ext(r)
                  );
              } else
                console.warn(
            ...
            (k.removeExt = function (r) {
              var a = Ba[r],
                i;
              return a
                ? (delete Ba[r], (i = a.removed), H(i) == p.f && i(), !0)
                : !1;
            });
          function bc(r, a, i) {
            (Xi = U.defaultOptions),
              ...
              (Yr = Tt !== or),
              (Er = z
                ? sr.hasClass(on) && sr.parent().hasClass(Vn)
                : sr.hasClass(we) && sr.children(je + Un)[s.l]);
            var c, l;
          ...
          return g.valid(bc(E, V, mr)) && Ma(E, k), k;
        }
        return (
          (g = X[ke] =
            function (E, V, mr) {
          ...
          (g.defaultOptions = function (E) {
            d();
            var V = m.defaultOptions;
            if (E === w) return R.extend(!0, {}, V);
            m.defaultOptions = R.extend(
              !0,
              {},
              V,
              u._validate(E, u._template, !0, V)._default
            );
          }),
          (g.valid = function (E) {
            return E instanceof g && !E.getState().destroyed;
          }),
          (g.extension = function (E, V, mr) {
            var U = O.type(E) == p.s,
              Pr = arguments[s.l],
              H = 0;
            ...
            if (U) {
              if (O.type(V) == p.f)
                f.push({ name: E, extensionFactory: V, defaultOptions: mr });
              else
                for (; H < f[s.l]; H++)
                  if (f[H].name === E)
    ...
    (Ni =
      ...
      function (ae) {
        for (var X = 1; X < arguments.length; X++) {
          var or = arguments[X];
          for (var w in or)
            Object.prototype.hasOwnProperty.call(or, w) && (ae[w] = or[w]);
        }
        return ae;
      }),
...
function Pc(ae, X) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (ke = 0; ke < p.length; ke++)
      (w = p[ke]),
        !(X.indexOf(w) >= 0) &&
          (!Object.prototype.propertyIsEnumerable.call(ae, w) ||
            (or[w] = ae[w]));
  }
  return or;
}
function Dc(ae, X) {
  ...
  for (p = 0; p < w.length; p++)
    (ke = w[p]), !(X.indexOf(ke) >= 0) && (or[ke] = ae[ke]);
  return or;
}
var zc = function (X) {
  var or = X.options,
    ...
    p = X.className,
    s = X.children,
    He = Pc(X, ['options', 'extensions', 'className', 'children']),
    O = xe.useRef(),
    N = xe.useRef();
  return (
    ...
    xe.useEffect(
      function () {
        nn.valid(N.current) && Ys(N.current, p);
      },
      [p]
    ),
    xe.createElement(
...
function Ys(ae, X) {
  if (nn.valid(ae)) {
    var or = ae.getElements(),
      ...
      ke = new RegExp(
        '(^os-host([-_].+|)$)|'.concat(
          ae.options().className.replace(/\s/g, '$|'),
          '$'
        ),
        'g'
      ),
      p = w.className
        ...
        .join(' ');
    w.className = ''.concat(p, ' ').concat(X || '');
  }
}
export { zc as OverlayScrollbarsComponent, zc as default };
//# sourceMappingURL=OverlayScrollbars.e7d2429a.js.map
